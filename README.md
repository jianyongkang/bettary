...
本项目经历了多次严谨的工程迭代，最终形成 V4.3.3 Golden Baseline。

### [v4.3.3] - Final Rigor (Current)
...
### [v4.3] - Baseline
  ...
  * **Final Polish**: 风险图颜色由模型判决结果决定，实现真正的盲测验证。
  * **Docs**: 规范了工程结构与输出路径。
...
### [v3.0] - The Closed Loop
  ...
  * **防泄露**: 软测量特征工程采用 Group-wise (按循环分组) 处理，消除了时序数据泄露风险。
